...
function ContactUs () {
  return (
   <section class="contactus">
            <h2 class="contactus_title">Get In Touch With Us</h2>
            <p class="contactus_subtitle">For More Information About Our Product & Services. Please Feel Free To Drop Us<br/>
            An Email. Our Staff Always Be There To Help You Out. Do Not Hesitate!</p>

            <div class="contactus_info">
                <div class="contacts">
                    <div class="contucts-subsection contacts-adress">
                        ...
                        <div class="contacts-info">
                            <p class="contacts_desc-bold">
                                Address
                            </p>
                            <p class="contacts_desc-light">
                                Tunguch , Bishkek,<br/>
                                Kyrgyzstan
                            </p>
                        </div>
                    ...
                    <div class="contucts-subsection contacts-phone">
                        <div class="contacts-icons">
                    ...
                    <div class="contucts-subsection contacts-time">
                        <div class="contacts-icons">
                ...
                <div class="personalInfo">
                    <div class="personalInfo_name">
                        <label class="personalInfo_desc-bold" for="user_name">Your name</label>
                        <input class="personalInfo_desc-input" name="user_name" id="user-name" placeholder="Abc"/>
                    </div>

                    <div class="personalInfo_adress">
                        <label class="personalInfo_desc-bold" for="user-adress">Email address</label>
                        <input class="personalInfo_desc-input" name="user_adress" id="user-adress" placeholder="Abc@def.com"/>
                    </div>

                    <div class="personalInfo_subject">
                        <label class="personalInfo_desc-bold" for="user-subject">Subject</label>
                        <input class="personalInfo_desc-input" name="user_subject" id="user-subject" placeholder="This is an optional"/>
                    </div>

                    <div class="personalInfo_message">
                        <label class="personalInfo_desc-bold" for="user-message">Message</label>
                        <input class="personalInfo_desc-input input_message" name="user-message" id="user-message" placeholder="Hi! i’d like to ask about"/>
                    </div>

                    <button class="personalInfo_button">Submit</button>
                </div>
            </div>
        </section>
  );
